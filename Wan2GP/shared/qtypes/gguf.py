...
class GGUFWeightTensor(QTensor):
    ...
    @staticmethod
    def __new__(cls, qtype, axis, size, stride, raw, tensor_type, tensor_shape, dtype, requires_grad=False, **kwargs):
    ...
    def __init__(self, qtype, axis, size, stride, raw, tensor_type, tensor_shape, dtype, requires_grad=False, **kwargs):
