...
class ScaledFP8WeightTensor(QTensor):
    ...
    @staticmethod
    def __new__(cls, qtype, axis, size, stride, weight, scale, dtype, requires_grad=False, **kwargs):
    ...
    def __init__(self, qtype, axis, size, stride, weight, scale, dtype, requires_grad=False, **kwargs):
