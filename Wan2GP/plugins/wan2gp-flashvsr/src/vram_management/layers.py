"""
VRAM Management Module for FlashVSR Plugin

This module provides VRAM optimization utilities copied from FlashVSR_plus.
It enables efficient offloading/onloading of model weights between CPU and GPU.

Source: https://github.com/lihaoyun6/FlashVSR_plus
License: Apache 2.0
"""
...
def cast_to(weight, dtype, device):
    """Cast weight tensor to specified dtype and device."""
...
class AutoWrappedModule(torch.nn.Module):
    """Wrapper for automatic offloading/onloading of arbitrary modules."""
...
class AutoWrappedLinear(torch.nn.Linear):
    """Wrapper for Linear layers with automatic offloading/onloading."""
    
    def __init__(self, module: torch.nn.Linear, offload_dtype, offload_device, 
                 onload_dtype, onload_device, computation_dtype, computation_device):
...
def enable_vram_management_recursively(
    ...
    module_map: dict, 
    module_config: dict, 
    max_num_param: Optional[int] = None, 
    overflow_module_config: Optional[dict] = None, 
    total_num_param: int = 0
):
    """Recursively wrap model modules for VRAM management."""
