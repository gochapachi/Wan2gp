...
class BasePipeline(torch.nn.Module):
    ...
    def check_resize_height_width(self, height, width):
        """
        Adjust height and width to be divisible by the division factor.
        """
    ...
    def preprocess_image(self, image):
        """
        Convert a PIL image or numpy array to a torch tensor.
        """
    ...
    def preprocess_images(self, images):
        """
        Convert a list of images to a list of torch tensors.
        """
    ...
    def vae_output_to_image(self, vae_output):
        """
        Convert VAE output tensor to a PIL image.
        """
    ...
    def vae_output_to_video(self, vae_output):
        """
        Convert VAE output tensor to a list of PIL images (video frames).
        """
    ...
    def enable_cpu_offload(self):
        """
        Enable CPU offloading for models to save VRAM.
        """
    ...
    def load_models_to_device(self, loadmodel_names=[]):
        """
        Load specified models to the device and offload others if CPU offload is enabled.
        """
