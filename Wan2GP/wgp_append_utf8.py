...
def n8n_generate_api(prompt, model_type="Wan2.1-T2V-1.3B", resolution="832x480", video_length=81, num_inference_steps=20, state=None):
    ...
    print(f"[n8n API] Received request: prompt='{prompt}', model='{model_type}', res='{resolution}', frames={video_length}")
    ...
    try:
        success = generate_video(
            ...
            activated_loras=[],
            loras_multipliers=[],
            image_prompt_type="Image Prompt",
            image_start=None,
            image_end=None,
            ...
            video_prompt_type="Video Prompt",
            image_refs=[],
            frames_positions=[],
            video_guide=None,
            image_guide=None,
            ...
            custom_guide=None,
            audio_source=None,
            audio_prompt_type="Audio Prompt",
            speakers_locations=[],
...
def create_ui():
    ...
    with gr.Blocks(css=css, js=js,  theme=theme, title= "WanGP") as main:
        ...
        with gr.Row(visible=False):
            ...
            n8n_btn.click(
                fn=n8n_generate_api,
                inputs=[n8n_prompt, n8n_model, n8n_res, n8n_frames, n8n_steps],
                outputs=[n8n_output],
...
def main():
    ...
    async def n8n_sync_endpoint(request: Request):
        try:
            ...
            # Call generation function synchronously
            # Pass a dummy state dict as n8n_generate_api expects it
            dummy_state = {} 
            
            result_url = n8n_generate_api(
                prompt=prompt,
