...
class BasicAVTransformerBlock(torch.nn.Module):
    ...
    def forward(
        ...
        def _forward_disabled(video, audio, perturbations):
            return self._forward_impl(video, audio, perturbations)
        return _forward_disabled(video, audio, perturbations)

    def _forward_impl(  # noqa: PLR0915
        self,
        video: TransformerArgs | None,
        audio: TransformerArgs | None,
        perturbations: BatchedPerturbationConfig | None = None,
